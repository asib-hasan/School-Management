                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <a href="{{url('admin/parent/my-student',['parent_id'=> $parentId])}}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
                                </div>
                              ...
                              @foreach ($getRecord as $i)
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        @else
                                            <a href="{{url('admin/parent/assign',['student_id'=> $i->id,'parent_id'=> $parentId])}}" class="btn btn-danger">Assign student</a>
                                        @endif
                            ...
                            <tbody>
                              @foreach ($AssignedStudent as $i)
                                  <tr>
                                      ...
                                      <td>{{$i->created_at}}</td>
                                      <td>
                                        <a  href="{{url('admin/parent/assigned/delete/'.$i->id)}}"class="btn btn-danger">Delete</a>
                                      </td>
                                  </tr> 
                                @endforeach
                            </tbody>
