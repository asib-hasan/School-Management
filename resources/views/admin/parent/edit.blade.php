                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary" style="width: 1000px">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                        <form method="post" action="{{ url('admin/parent/update') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control"
                                             name="first_name" value="{{$getRecord->first_name}}" placeholder="Enter first name">
                                    </div>
                                    <div class="form-group col-6">
                                    ...
                                    <div class="form-group col-6">
                                      ...
                                      <input type="text" class="form-control" 
                                           name="occupation" value = "{{$getRecord->occupation}}"placeholder="Enter occupation">
                                    </div>

                                    <div class="form-group col-6">
                                      <label for="Name">Mobile Number</label>
                                      <input type="text" class="form-control" 
                                           name="phone" value="{{$getRecord->phone}}" placeholder="Enter mobile number">
                                    </div>
                                    ...
                                    <div class="form-group col-6">
                                      ...
                                      <input type="text" class="form-control" 
                                           name="address" placeholder="Enter address" value="{{$getRecord->address}}">
                                    </div>
